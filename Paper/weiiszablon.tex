...
modelowania, animowania i teksturowania. W raz z czasem powstały pierwsze
silniki graficzne. Początkowo nie były one zbyt rozwinięte – posiadały proste
systemy kolizji, bardzo proste systemy cząsteczkowe, obsługa animacji
szkieletowych, modeli i dźwięku. Wraz z czasem silniki były coraz bardziej
optymalizowane i rozwijane. Rozwój oprogramowania szedł w parze z rozwojem
sprzętu.

Większość dużych firm zajmujących się tworzeniem gier tworzyła własne silniki
graficzne. Każdy z tych silników jest w pewien sposób unikalny oraz posiada
swoje problemy, z którymi muszą się zmagać twórcy gier. Wymagania doświadczenia
pracowników oraz koszty utrzymania i modernizacji silników coraz bardziej
popychają twórców do używania silników, które są udostępniane i wspierane przez
inne firmy. 
